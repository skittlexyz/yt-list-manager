...
function Header() {
    return (
        <div className='pt-[2rem] fixed w-full max-w-[280px] 2xl:max-w-[1280px] xl:max-w-[1100px] lg:max-w-[900px] md:max-w-[600px] bg-white dark:bg-gray-950'>
